...
/**
 * Brand marks — lucide-react removed brand/logo glyphs (Github, X, Discord, …)
 * in recent versions, so we ship our own inline SVGs. They accept `className`
 * (size via `size-*`, color via `text-*`) and spread like a lucide icon.
 */
